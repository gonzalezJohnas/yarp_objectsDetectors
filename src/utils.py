...
def get_bouding_box_coordinates(norm_rect, img_shape):
    """

    :param norm_rect: List of normalized values
    :param img_shape: By definition width is the first dimension and height the second
    :return: left top right bottom coordinate
    """
